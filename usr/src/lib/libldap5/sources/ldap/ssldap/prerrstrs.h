...
ER2( PR_FILE_IS_BUSY_ERROR,		dgettext(TEXT_DOMAIN,
	"The file is busy.") )
ER2( PR_OPERATION_ABORTED_ERROR,		dgettext(TEXT_DOMAIN,
...
ER2( PR_NETWORK_DOWN_ERROR,		dgettext(TEXT_DOMAIN,
	"Network is down.") )
#endif

#ifdef PR_SOCKET_SHUTDOWN_ERROR
ER2( PR_SOCKET_SHUTDOWN_ERROR,		dgettext(TEXT_DOMAIN,
	"The socket was previously shut down.") )
#endif

#ifdef PR_CONNECT_ABORTED_ERROR
ER2( PR_CONNECT_ABORTED_ERROR,		dgettext(TEXT_DOMAIN,
	"TCP Connection aborted.") )
#endif

#ifdef PR_HOST_UNREACHABLE_ERROR
ER2( PR_HOST_UNREACHABLE_ERROR,		dgettext(TEXT_DOMAIN,
	"Host is unreachable.") )
#endif
#else
